...
// `note` is a single optional short string for that week. Nothing here reads
// or duplicates team/player names - callers join against the team record
// they already have, same as everywhere else in the app.
(function (root) {
  ...
  const Availability = { DAYS, DAY_LABELS, isoDate, weekStartDate, currentWeekStartISO, formatWeekRange, forTeamWeek, saveAvailability };
